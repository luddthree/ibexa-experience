 ...
 */
final class ArticleItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ArticleItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'title' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "title", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'shortTitle' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "short_title", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'author' => [
                    'type' => fn() => Type::listOf($services->getType('AuthorFieldValue')),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return ((($services->query("ItemFieldValue", ...[0 => $value, 1 => "author", 2 => $args]) !== null)) ? ($services->query("ItemFieldValue", ...[0 => $value, 1 => "author", 2 => $args])->authors) : (null));
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'intro' => [
                    'type' => fn() => $services->getType('RichTextFieldValue'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "intro", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'body' => [
                    'type' => fn() => $services->getType('RichTextFieldValue'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "body", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'enableComments' => [
                    'type' => Type::boolean(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return ((($services->query("ItemFieldValue", ...[0 => $value, 1 => "enable_comments", 2 => $args]) !== null)) ? ($services->query("ItemFieldValue", ...[0 => $value, 1 => "enable_comments", 2 => $args])->bool) : (null));
                    },
                ],
                'image' => [
                    'type' => fn() => $services->getType('Item'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("RelationFieldValue", ...[0 => $services->query("ItemFieldValue", ...[0 => $value, 1 => "image", 2 => $args]), 1 => false]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
