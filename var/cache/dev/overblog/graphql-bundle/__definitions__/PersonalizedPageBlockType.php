 ...
 */
final class PersonalizedPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'PersonalizedPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'number' => [
                    'type' => Type::int(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("number")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
