 ...
 */
final class IntegerFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'IntegerFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'constraints' => [
                    'type' => fn() => $services->getType('IntegerFieldDefinitionConstraints'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
