 ...
 */
final class ProductsWithLowestStockPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ProductsWithLowestStockPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'stock' => [
                    'type' => Type::int(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("stock")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
