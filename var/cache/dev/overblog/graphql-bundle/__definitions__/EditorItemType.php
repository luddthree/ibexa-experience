 ...
 */
final class EditorItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'EditorItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'firstName' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "first_name", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'lastName' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "last_name", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'userAccount' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "user_account", 2 => $args])->id;
                    },
                ],
                'image' => [
                    'type' => fn() => $services->getType('ImageFieldValue'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "image", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'signature' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "signature", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'position' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "position", 2 => $args]);
                    },
                ],
                'department' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "department", 2 => $args]);
                    },
                ],
                'location' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "location", 2 => $args]);
                    },
                ],
                'phone' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "phone", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'linkedIn' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "linked_in", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
