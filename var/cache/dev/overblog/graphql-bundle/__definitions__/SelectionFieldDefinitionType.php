 ...
 */
final class SelectionFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'SelectionFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'settings' => [
                    'type' => fn() => $services->getType('SelectionFieldDefinitionSettings'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
