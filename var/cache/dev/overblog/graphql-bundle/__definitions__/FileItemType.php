 ...
 */
final class FileItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'FileItem';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'file' => [
                    'type' => fn() => $services->getType('BinaryFileFieldValue'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "file", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
