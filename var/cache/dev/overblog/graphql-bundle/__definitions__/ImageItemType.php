 ...
 */
final class ImageItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ImageItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'caption' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "caption", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'tags' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return ((($services->query("ItemFieldValue", ...[0 => $value, 1 => "tags", 2 => $args]) !== null)) ? ($services->query("ItemFieldValue", ...[0 => $value, 1 => "tags", 2 => $args])->values) : (null));
                    },
                    'args' => [
                        [
                            'name' => 'language',
