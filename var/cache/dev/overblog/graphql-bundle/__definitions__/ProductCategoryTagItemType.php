 ...
 */
final class ProductCategoryTagItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ProductCategoryTagItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'identifier' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "identifier", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'parent' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "parent", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'image' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("DomainImageAssetFieldValue", ...[0 => $services->query("ItemFieldValue", ...[0 => $value, 1 => "image", 2 => $args])]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
