 ...
 */
final class BannerPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'BannerPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'url' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("url")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
