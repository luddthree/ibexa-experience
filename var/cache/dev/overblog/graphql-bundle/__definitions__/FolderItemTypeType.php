 ...
 */
final class FolderItemTypeType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'FolderItemType';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'shortName' => [
                    'type' => fn() => $services->getType('TextLineFieldDefinition'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getFieldDefinition("short_name");
                    },
                ],
                'shortDescription' => [
                    'type' => fn() => $services->getType('MatrixFieldDefinition'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getFieldDefinition("short_description");
                    },
                ],
                'description' => [
                    'type' => fn() => $services->getType('MatrixFieldDefinition'),
