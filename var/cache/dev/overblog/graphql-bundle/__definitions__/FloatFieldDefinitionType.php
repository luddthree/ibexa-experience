 ...
 */
final class FloatFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'FloatFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'constraints' => [
                    'type' => fn() => $services->getType('FloatFieldDefinitionConstraints'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
