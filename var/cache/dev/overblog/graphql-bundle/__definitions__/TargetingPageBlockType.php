 ...
 */
final class TargetingPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'TargetingPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'defaultContentId' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("EmbedAttributeValue", ...[0 => $value->getAttribute("default_content_id")->getValue()]);
                    },
                ],
            ],
            'interfaces' => fn() => [
