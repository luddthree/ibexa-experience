 ...
 */
final class FormItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'FormItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'form' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "form", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
