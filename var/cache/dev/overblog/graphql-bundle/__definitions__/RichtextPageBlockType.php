 ...
 */
final class RichtextPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'RichtextPageBlock';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'content' => [
                    'type' => fn() => $services->getType('RichTextBlockAttributeValue'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("content")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
