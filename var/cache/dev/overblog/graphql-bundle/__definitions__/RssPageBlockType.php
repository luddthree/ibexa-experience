 ...
 */
final class RssPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'RssPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'offset' => [
                    'type' => Type::int(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("offset")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
