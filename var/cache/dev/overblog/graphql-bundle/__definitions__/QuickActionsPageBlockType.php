 ...
 */
final class QuickActionsPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'QuickActionsPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'actions' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("actions")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
