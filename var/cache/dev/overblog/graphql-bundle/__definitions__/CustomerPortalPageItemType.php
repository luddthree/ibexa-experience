 ...
 */
final class CustomerPortalPageItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'CustomerPortalPageItem';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'page' => [
                    'type' => fn() => $services->getType('Page'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("Page", ...[0 => $services->query("ItemFieldValue", ...[0 => $value, 1 => "page", 2 => $args]), 1 => $context]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
