 ...
 */
final class QualifioPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'QualifioPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'width' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("width")->getValue();
                    },
                ],
                'height' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getAttribute("height")->getValue();
                    },
                ],
            ],
            'interfaces' => fn() => [
