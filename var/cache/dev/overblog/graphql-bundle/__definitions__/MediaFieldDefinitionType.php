 ...
 */
final class MediaFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'MediaFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'constraints' => [
                    'type' => fn() => $services->getType('BinaryFieldDefinitionConstraints'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $value->getValidatorConfiguration();
                    },
                ],
                'settings' => [
                    'type' => fn() => $services->getType('MediaFieldDefinitionSettings'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
