 ...
 */
final class ContentQueryFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ContentQueryFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'settings' => [
                    'type' => fn() => $services->getType('ContentQueryFieldSettings'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
