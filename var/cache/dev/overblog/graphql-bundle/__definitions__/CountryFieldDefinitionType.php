 ...
 */
final class CountryFieldDefinitionType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'CountryFieldDefinition';
    ...
    public function __construct(ConfigProcessor $configProcessor, GraphQLServices $services)
    {
        $config = [
            ...
            'fields' => fn() => [
                ...
                'settings' => [
                    'type' => fn() => $services->getType('CountryFieldDefinitionSettings'),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
