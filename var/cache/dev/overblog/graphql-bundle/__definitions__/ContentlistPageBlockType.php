 ...
 */
final class ContentlistPageBlockType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'ContentlistPageBlock';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'contentId' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("EmbedAttributeValue", ...[0 => $value->getAttribute("contentId")->getValue()]);
                    },
                ],
                'limit' => [
                    'type' => Type::int(),
                ...
                'contentType' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ContentTypeListStorageValue", ...[0 => $value->getAttribute("contentType")->getValue()]);
                    },
                ],
            ],
            'interfaces' => fn() => [
