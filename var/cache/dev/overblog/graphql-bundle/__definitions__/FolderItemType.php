 ...
 */
final class FolderItemType extends ObjectType implements GeneratedTypeInterface, AliasedInterface
{
    public const NAME = 'FolderItem';
        ...
        $config = [
            ...
            'fields' => fn() => [
                ...
                'shortName' => [
                    'type' => Type::string(),
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "short_name", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
                ...
                'shortDescription' => [
                    ...
                    'resolve' => function ($value, $args, $context, $info) use ($services) {
                        return $services->query("ItemFieldValue", ...[0 => $value, 1 => "short_description", 2 => $args]);
                    },
                    'args' => [
                        [
                            'name' => 'language',
