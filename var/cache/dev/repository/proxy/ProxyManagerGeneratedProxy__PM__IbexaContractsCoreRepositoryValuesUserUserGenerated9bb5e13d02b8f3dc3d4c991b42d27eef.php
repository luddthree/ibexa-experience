...
namespace ProxyManagerGeneratedProxy\__PM__\Ibexa\Contracts\Core\Repository\Values\User\User;

class Generated9bb5e13d02b8f3dc3d4c991b42d27eef extends \Ibexa\Contracts\Core\Repository\Values\User\User implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Contracts\Core\Repository\Values\User\User|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature9bb5e13d02b8f3dc3d4c991b42d27eef = '';

    public function getUserId() : int
    {
        $this->initializerf0d6f && ($this->initializerf0d6f->__invoke($valueHolder3c8ba, $this, 'getUserId', array(), $this->initializerf0d6f) || 1) && $this->valueHolder3c8ba = $valueHolder3c8ba;

        return $this->valueHolder3c8ba->getUserId();
    }

    public function getLogin() : string
    {
        $this->initializerf0d6f && ($this->initializerf0d6f->__invoke($valueHolder3c8ba, $this, 'getLogin', array(), $this->initializerf0d6f) || 1) && $this->valueHolder3c8ba = $valueHolder3c8ba;

        return $this->valueHolder3c8ba->getLogin();
    }

    public function getPasswordHash() : string
    {
        $this->initializerf0d6f && ($this->initializerf0d6f->__invoke($valueHolder3c8ba, $this, 'getPasswordHash', array(), $this->initializerf0d6f) || 1) && $this->valueHolder3c8ba = $valueHolder3c8ba;

        return $this->valueHolder3c8ba->getPasswordHash();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->login, $instance->email, $instance->passwordHash, $instance->passwordUpdatedAt, $instance->hashAlgorithm, $instance->enabled, $instance->maxLogin);
    ...
    public function __construct(array $properties = [])
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Contracts\\Core\\Repository\\Values\\User\\User');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->login, $this->email, $this->passwordHash, $this->passwordUpdatedAt, $this->hashAlgorithm, $this->enabled, $this->maxLogin);
    ...
    public function __isset($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Contracts\\Core\\Repository\\Values\\User\\User');
