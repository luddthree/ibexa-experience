...
class CoreInstaller_89e65a4 extends \Ibexa\Bundle\RepositoryInstaller\Installer\CoreInstaller implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Bundle\RepositoryInstaller\Installer\CoreInstaller|null wrapped object, if the proxy is initialized
     */
    ...
    public function importData()
    {
        ...
        return $this->valueHolder3c8ba->importData();
    }
    ...
    public function __construct(\Doctrine\DBAL\Connection $db, \Ibexa\Contracts\DoctrineSchema\Builder\SchemaBuilderInterface $schemaBuilder)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Bundle\\RepositoryInstaller\\Installer\\CoreInstaller');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->schemaBuilder, $this->db, $this->output, $this->baseDataDir);

        }

        $this->valueHolder3c8ba->__construct($db, $schemaBuilder);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Bundle\\RepositoryInstaller\\Installer\\CoreInstaller');
...
if (!\class_exists('CoreInstaller_89e65a4', false)) {
    \class_alias(__NAMESPACE__.'\\CoreInstaller_89e65a4', 'CoreInstaller_89e65a4', false);
}
