...
class AuthorsTab_9c2b1c8 extends \Ibexa\AdminUi\Tab\LocationView\AuthorsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\LocationView\AuthorsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\AuthorsTab $instance) {
            unset($instance->userService);
        }, $instance, 'Ibexa\\AdminUi\\Tab\\LocationView\\AuthorsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\Contracts\Core\Repository\UserService $userService, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\AuthorsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\AuthorsTab $instance) {
            unset($instance->userService);
        }, $this, 'Ibexa\\AdminUi\\Tab\\LocationView\\AuthorsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $userService, $eventDispatcher);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\AuthorsTab');
...
if (!\class_exists('AuthorsTab_9c2b1c8', false)) {
    \class_alias(__NAMESPACE__.'\\AuthorsTab_9c2b1c8', 'AuthorsTab_9c2b1c8', false);
}
