...
class AssetsTab_2406885 extends \Ibexa\ProductCatalog\Tab\Product\AssetsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\AssetsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\AssetsTab $instance) {
            unset($instance->assetService, $instance->formFactory, $instance->urlGenerator, $instance->assetGroupCollectionFactory, $instance->maxUploadSize);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Product\\AssetsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\AssetServiceInterface $assetService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator, \Ibexa\Bundle\ProductCatalog\UI\AssetGroup\AssetGroupCollectionFactoryInterface $assetGroupCollectionFactory, \Ibexa\ContentForms\ConfigResolver\MaxUploadSize $maxUploadSize)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\AssetsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\AssetsTab $instance) {
            unset($instance->assetService, $instance->formFactory, $instance->urlGenerator, $instance->assetGroupCollectionFactory, $instance->maxUploadSize);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\Product\\AssetsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $assetService, $formFactory, $urlGenerator, $assetGroupCollectionFactory, $maxUploadSize);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\AssetsTab');
...
if (!\class_exists('AssetsTab_2406885', false)) {
    \class_alias(__NAMESPACE__.'\\AssetsTab_2406885', 'AssetsTab_2406885', false);
}
