...
class CommerceInstaller_1d86cd7 extends \Ibexa\Installer\Installer\CommerceInstaller implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Installer\Installer\CommerceInstaller|null wrapped object, if the proxy is initialized
     */
...
return;
    ...
    public function __construct(\Doctrine\DBAL\Connection $db, \Ibexa\Contracts\DoctrineSchema\Builder\SchemaBuilderInterface $schemaBuilder, iterable $provisioners)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Installer\\Installer\\CommerceInstaller');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Installer\\Installer\\CommerceInstaller');
...
if (!\class_exists('CommerceInstaller_1d86cd7', false)) {
    \class_alias(__NAMESPACE__.'\\CommerceInstaller_1d86cd7', 'CommerceInstaller_1d86cd7', false);
}
