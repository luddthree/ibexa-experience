...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/workflow/src/lib/Search/Criterion/Handler/ContentIsOnInitialStage.php';

class ContentIsOnInitialStage_cdb8120 extends \Ibexa\Workflow\Search\Criterion\Handler\ContentIsOnInitialStage implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Workflow\Search\Criterion\Handler\ContentIsOnInitialStage|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\Workflow\Search\Criterion\Handler\ContentIsOnInitialStage $instance) {
            unset($instance->workflowDefinitionMetadataRegistry);
        }, $instance, 'Ibexa\\Workflow\\Search\\Criterion\\Handler\\ContentIsOnInitialStage')->__invoke($instance);
    ...
    public function __construct(\Doctrine\DBAL\Connection $connection, \Ibexa\Contracts\Workflow\Registry\WorkflowDefinitionMetadataRegistryInterface $workflowDefinitionMetadataRegistry)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Workflow\\Search\\Criterion\\Handler\\ContentIsOnInitialStage');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->comparatorMap, $this->connection, $this->dbPlatform);

        \Closure::bind(function (\Ibexa\Workflow\Search\Criterion\Handler\ContentIsOnInitialStage $instance) {
            unset($instance->workflowDefinitionMetadataRegistry);
        }, $this, 'Ibexa\\Workflow\\Search\\Criterion\\Handler\\ContentIsOnInitialStage')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Workflow\\Search\\Criterion\\Handler\\ContentIsOnInitialStage');
...
if (!\class_exists('ContentIsOnInitialStage_cdb8120', false)) {
    \class_alias(__NAMESPACE__.'\\ContentIsOnInitialStage_cdb8120', 'ContentIsOnInitialStage_cdb8120', false);
}
