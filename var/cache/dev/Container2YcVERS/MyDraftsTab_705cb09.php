...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/admin-ui/src/lib/Tab/Dashboard/MyDraftsTab.php';

class MyDraftsTab_705cb09 extends \Ibexa\AdminUi\Tab\Dashboard\MyDraftsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\Dashboard\MyDraftsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->contentService, $instance->contentTypeService, $instance->permissionResolver, $instance->datasetFactory, $instance->twig, $instance->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\Dashboard\MyDraftsTab $instance) {
            unset($instance->requestStack, $instance->configResolver);
        }, $instance, 'Ibexa\\AdminUi\\Tab\\Dashboard\\MyDraftsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\Contracts\Core\Repository\ContentService $contentService, \Ibexa\Contracts\Core\Repository\ContentTypeService $contentTypeService, \Ibexa\Contracts\Core\Repository\PermissionResolver $permissionResolver, \Ibexa\AdminUi\UI\Dataset\DatasetFactory $datasetFactory, \Symfony\Component\HttpFoundation\RequestStack $requestStack, \Ibexa\Contracts\Core\SiteAccess\ConfigResolverInterface $configResolver)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\Dashboard\\MyDraftsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->contentService, $this->contentTypeService, $this->permissionResolver, $this->datasetFactory, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\Dashboard\MyDraftsTab $instance) {
            unset($instance->requestStack, $instance->configResolver);
        }, $this, 'Ibexa\\AdminUi\\Tab\\Dashboard\\MyDraftsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $contentService, $contentTypeService, $permissionResolver, $datasetFactory, $requestStack, $configResolver);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\Dashboard\\MyDraftsTab');
...
if (!\class_exists('MyDraftsTab_705cb09', false)) {
    \class_alias(__NAMESPACE__.'\\MyDraftsTab_705cb09', 'MyDraftsTab_705cb09', false);
}
