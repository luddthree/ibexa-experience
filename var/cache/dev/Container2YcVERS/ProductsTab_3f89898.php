...
class ProductsTab_3f89898 extends \Ibexa\ProductCatalog\Tab\Category\ProductsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Category\ProductsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Category\ProductsTab $instance) {
            unset($instance->productService, $instance->configResolver, $instance->requestStack, $instance->taxonomyConfiguration, $instance->taxonomyService, $instance->formFactory, $instance->queryTypeRegistry);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Category\\ProductsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\ProductServiceInterface $productService, \Ibexa\Contracts\Core\SiteAccess\ConfigResolverInterface $configResolver, \Symfony\Component\HttpFoundation\RequestStack $requestStack, \Ibexa\Taxonomy\Service\TaxonomyConfiguration $taxonomyConfiguration, \Ibexa\Contracts\Taxonomy\Service\TaxonomyServiceInterface $taxonomyService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\QueryTypeRegistryInterface $queryTypeRegistry)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Category\\ProductsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Category\ProductsTab $instance) {
            unset($instance->productService, $instance->configResolver, $instance->requestStack, $instance->taxonomyConfiguration, $instance->taxonomyService, $instance->formFactory, $instance->queryTypeRegistry);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\Category\\ProductsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $productService, $configResolver, $requestStack, $taxonomyConfiguration, $taxonomyService, $formFactory, $queryTypeRegistry);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Category\\ProductsTab');
...
if (!\class_exists('ProductsTab_3f89898', false)) {
    \class_alias(__NAMESPACE__.'\\ProductsTab_3f89898', 'ProductsTab_3f89898', false);
}
