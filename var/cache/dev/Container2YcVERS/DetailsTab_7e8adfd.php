...
class DetailsTab_7e8adfd extends \Ibexa\AdminUi\Tab\LocationView\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\LocationView\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\DetailsTab $instance) {
            unset($instance->sectionService, $instance->datasetFactory, $instance->formFactory, $instance->permissionResolver, $instance->userSettingService);
        }, $instance, 'Ibexa\\AdminUi\\Tab\\LocationView\\DetailsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\Contracts\Core\Repository\SectionService $sectionService, \Ibexa\AdminUi\UI\Dataset\DatasetFactory $datasetFactory, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\Core\Repository\PermissionResolver $permissionResolver, \Ibexa\User\UserSetting\UserSettingService $userSettingService, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\DetailsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\DetailsTab $instance) {
            unset($instance->sectionService, $instance->datasetFactory, $instance->formFactory, $instance->permissionResolver, $instance->userSettingService);
        }, $this, 'Ibexa\\AdminUi\\Tab\\LocationView\\DetailsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $sectionService, $datasetFactory, $formFactory, $permissionResolver, $userSettingService, $eventDispatcher);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\DetailsTab');
...
if (!\class_exists('DetailsTab_7e8adfd', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_7e8adfd', 'DetailsTab_7e8adfd', false);
}
