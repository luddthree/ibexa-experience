...
class AttributesTab_b169354 extends \Ibexa\ProductCatalog\Tab\AttributeGroup\AttributesTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\AttributeGroup\AttributesTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\AttributeGroup\AttributesTab $instance) {
            unset($instance->attributeDefinitionService, $instance->formFactory, $instance->urlGenerator, $instance->configResolver);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\AttributesTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\AttributeDefinitionServiceInterface $attributeDefinitionService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $router, \Ibexa\Contracts\Core\SiteAccess\ConfigResolverInterface $configResolver)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\AttributesTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\AttributeGroup\AttributesTab $instance) {
            unset($instance->attributeDefinitionService, $instance->formFactory, $instance->urlGenerator, $instance->configResolver);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\AttributesTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $attributeDefinitionService, $formFactory, $router, $configResolver);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\AttributesTab');
...
if (!\class_exists('AttributesTab_b169354', false)) {
    \class_alias(__NAMESPACE__.'\\AttributesTab_b169354', 'AttributesTab_b169354', false);
}
