...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/bundle/Routing/OptionsLoader.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/bundle/Routing/OptionsLoader/RouteCollectionMapper.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/bundle/Routing/OptionsLoader/Mapper.php';
        ...
        $a->addLoader(new \Ibexa\Bundle\Rest\Routing\OptionsLoader(new \Ibexa\Bundle\Rest\Routing\OptionsLoader\RouteCollectionMapper(new \Ibexa\Bundle\Rest\Routing\OptionsLoader\Mapper()), ($container->privates['Ibexa\\Bundle\\Core\\Routing\\DefaultRouter'] ?? $container->load('getDefaultRouterService'))));
        $a->addLoader($c);
