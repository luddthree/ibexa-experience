...
{
    /**
     * Gets the public 'Ibexa\Rest\Server\Controller\Content' shared autowired service.
     *
     * @return \Ibexa\Rest\Server\Controller\Content
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller/Content.php';

        $container->services['Ibexa\\Rest\\Server\\Controller\\Content'] = $instance = new \Ibexa\Rest\Server\Controller\Content();
