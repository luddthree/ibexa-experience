...
class ViewTab_4779bef extends \Ibexa\AdminUi\Tab\ContentType\ViewTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\ContentType\ViewTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\ContentType\\ViewTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\ContentType\\ViewTab');
...
if (!\class_exists('ViewTab_4779bef', false)) {
    \class_alias(__NAMESPACE__.'\\ViewTab_4779bef', 'ViewTab_4779bef', false);
}
