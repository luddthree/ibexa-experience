...
class DetailsTab_7ae2f4f extends \Ibexa\ProductCatalog\Tab\AttributeDefinition\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\AttributeDefinition\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeDefinition\\DetailsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeDefinition\\DetailsTab');
...
if (!\class_exists('DetailsTab_7ae2f4f', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_7ae2f4f', 'DetailsTab_7ae2f4f', false);
}
