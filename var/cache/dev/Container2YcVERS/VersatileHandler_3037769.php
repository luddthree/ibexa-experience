...
class VersatileHandler_3037769 implements \ProxyManager\Proxy\VirtualProxyInterface, \Ibexa\Contracts\Core\Search\VersatileHandler
{
    /**
     * @var \Ibexa\Contracts\Core\Search\VersatileHandler|null wrapped object, if the proxy is initialized
     */
...
return;
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Contracts\\Core\\Search\\VersatileHandler');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Contracts\\Core\\Search\\VersatileHandler');
...
if (!\class_exists('VersatileHandler_3037769', false)) {
    \class_alias(__NAMESPACE__.'\\VersatileHandler_3037769', 'VersatileHandler_3037769', false);
}
