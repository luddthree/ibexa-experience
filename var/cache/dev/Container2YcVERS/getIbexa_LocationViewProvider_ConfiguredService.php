 ...
 */
class getIbexa_LocationViewProvider_ConfiguredService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.location_view_provider.configured' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['ibexa.location_view_provider.configured'])) {
            return $container->privates['ibexa.location_view_provider.configured'];
        }
        ...
        return $container->privates['ibexa.location_view_provider.configured'] = new \Ibexa\Bundle\Core\View\Provider\Configured(new \Ibexa\Core\MVC\Symfony\Matcher\DynamicallyConfiguredMatcherFactoryDecorator(new \Ibexa\Bundle\Core\Matcher\ServiceAwareMatcherFactory($a, $b, 'Ibexa\\Core\\MVC\\Symfony\\Matcher\\ContentBased'), ($container->services['Ibexa\\Bundle\\Core\\DependencyInjection\\Configuration\\ChainConfigResolver'] ?? $container->getChainConfigResolverService()), 'location_view'));
    }
}
