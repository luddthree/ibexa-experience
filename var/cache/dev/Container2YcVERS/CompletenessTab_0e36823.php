...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Tab/Product/CompletenessTab.php';

class CompletenessTab_0e36823 extends \Ibexa\ProductCatalog\Tab\Product\CompletenessTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\CompletenessTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\CompletenessTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\CompletenessTab');
...
if (!\class_exists('CompletenessTab_0e36823', false)) {
    \class_alias(__NAMESPACE__.'\\CompletenessTab_0e36823', 'CompletenessTab_0e36823', false);
}
