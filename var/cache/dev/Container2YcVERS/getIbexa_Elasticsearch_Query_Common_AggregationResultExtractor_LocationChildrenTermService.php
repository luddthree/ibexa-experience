 ...
 */
class getIbexa_Elasticsearch_Query_Common_AggregationResultExtractor_LocationChildrenTermService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.elasticsearch.query.common.aggregation_result_extractor.location_children_term' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['ibexa.elasticsearch.query.common.aggregation_result_extractor.location_children_term'])) {
            return $container->privates['ibexa.elasticsearch.query.common.aggregation_result_extractor.location_children_term'];
        }

        return $container->privates['ibexa.elasticsearch.query.common.aggregation_result_extractor.location_children_term'] = new \Ibexa\Elasticsearch\Query\ResultExtractor\AggregationResultExtractor\TermAggregationResultExtractor('Ibexa\\Contracts\\Core\\Repository\\Values\\Content\\Query\\Aggregation\\Location\\LocationChildrenTermAggregation', $a);
    }
}
