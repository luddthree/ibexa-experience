...
{
    /**
     * Gets the public 'Ibexa\Rest\Server\Controller\Options' shared autowired service.
     *
     * @return \Ibexa\Rest\Server\Controller\Options
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller/Options.php';

        $container->services['Ibexa\\Rest\\Server\\Controller\\Options'] = $instance = new \Ibexa\Rest\Server\Controller\Options();
