...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Tab/Product/TranslationsTab.php';

class TranslationsTab_8161afa extends \Ibexa\ProductCatalog\Tab\Product\TranslationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\TranslationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\PermissionResolverInterface $permissionResolver, \Ibexa\Contracts\Core\Repository\LanguageService $languageService, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\TranslationsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\TranslationsTab');
...
if (!\class_exists('TranslationsTab_8161afa', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationsTab_8161afa', 'TranslationsTab_8161afa', false);
}
