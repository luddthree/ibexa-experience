...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/core/src/bundle/Core/DependencyInjection/Configuration/ConfigResolver/DefaultScopeConfigResolver.php';

class DefaultScopeConfigResolver_7befcf7 extends \Ibexa\Bundle\Core\DependencyInjection\Configuration\ConfigResolver\DefaultScopeConfigResolver implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Bundle\Core\DependencyInjection\Configuration\ConfigResolver\DefaultScopeConfigResolver|null wrapped object, if the proxy is initialized
     */
...
return;
    ...
    public function __construct(string $defaultNamespace)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Bundle\\Core\\DependencyInjection\\Configuration\\ConfigResolver\\DefaultScopeConfigResolver');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Bundle\\Core\\DependencyInjection\\Configuration\\ConfigResolver\\DefaultScopeConfigResolver');
...
if (!\class_exists('DefaultScopeConfigResolver_7befcf7', false)) {
    \class_alias(__NAMESPACE__.'\\DefaultScopeConfigResolver_7befcf7', 'DefaultScopeConfigResolver_7befcf7', false);
}
