...
class DetailsTab_606f745 extends \Ibexa\ProductCatalog\Tab\Product\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\DetailsTab $instance) {
            unset($instance->localProductService, $instance->formFactory, $instance->requestStack, $instance->fieldDefinitionGroupsUtil);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Product\\DetailsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\Local\LocalProductServiceInterface $localProductService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Symfony\Component\HttpFoundation\RequestStack $requestStack, \Ibexa\AdminUi\Util\FieldDefinitionGroupsUtil $fieldDefinitionGroupsUtil)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\DetailsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\DetailsTab $instance) {
            unset($instance->localProductService, $instance->formFactory, $instance->requestStack, $instance->fieldDefinitionGroupsUtil);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\Product\\DetailsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $localProductService, $formFactory, $requestStack, $fieldDefinitionGroupsUtil);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\DetailsTab');
...
if (!\class_exists('DetailsTab_606f745', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_606f745', 'DetailsTab_606f745', false);
}
