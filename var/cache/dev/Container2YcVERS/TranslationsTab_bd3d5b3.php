...
class TranslationsTab_bd3d5b3 extends \Ibexa\ProductCatalog\Tab\AttributeGroup\TranslationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\AttributeGroup\TranslationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\PermissionResolverInterface $permissionResolver, \Ibexa\Contracts\Core\Repository\LanguageService $languageService, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\TranslationsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\TranslationsTab');
...
if (!\class_exists('TranslationsTab_bd3d5b3', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationsTab_bd3d5b3', 'TranslationsTab_bd3d5b3', false);
}
