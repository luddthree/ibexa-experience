...
class TranslationsTab_4f0a941 extends \Ibexa\AdminUi\Tab\ContentType\TranslationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\ContentType\TranslationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->datasetFactory, $instance->formFactory, $instance->eventDispatcher, $instance->twig, $instance->translator);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\AdminUi\UI\Dataset\DatasetFactory $datasetFactory, \Ibexa\AdminUi\Form\Factory\ContentTypeFormFactory $formFactory)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\ContentType\\TranslationsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->datasetFactory, $this->formFactory, $this->eventDispatcher, $this->twig, $this->translator);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $datasetFactory, $formFactory);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\ContentType\\TranslationsTab');
...
if (!\class_exists('TranslationsTab_4f0a941', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationsTab_4f0a941', 'TranslationsTab_4f0a941', false);
}
