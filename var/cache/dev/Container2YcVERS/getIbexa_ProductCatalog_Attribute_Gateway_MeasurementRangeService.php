 ...
 */
class getIbexa_ProductCatalog_Attribute_Gateway_MeasurementRangeService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.product_catalog.attribute.gateway.measurement_range' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/measurement/src/lib/ProductCatalog/Local/Attribute/RangeMeasurementStorageDefinition.php';
        ...
        if (isset($container->privates['ibexa.product_catalog.attribute.gateway.measurement_range'])) {
            return $container->privates['ibexa.product_catalog.attribute.gateway.measurement_range'];
        }

        return $container->privates['ibexa.product_catalog.attribute.gateway.measurement_range'] = new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Inheritance\Gateway(($container->services['ibexa.persistence.connection'] ?? $container->getIbexa_Persistence_ConnectionService()), $a, new RewindableGenerator(function () use ($container) {
        ...
        }, 8), new \Ibexa\Measurement\ProductCatalog\Local\Attribute\RangeMeasurementStorageDefinition(), [0 => 'measurement_range']);
    }
}
