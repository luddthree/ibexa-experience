...
{
    /**
     * Gets the public 'Ibexa\Rest\Server\Controller\Section' shared autowired service.
     *
     * @return \Ibexa\Rest\Server\Controller\Section
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller/Section.php';

        $container->services['Ibexa\\Rest\\Server\\Controller\\Section'] = $instance = new \Ibexa\Rest\Server\Controller\Section(($container->services['ibexa.api.service.section'] ?? $container->getIbexa_Api_Service_SectionService()));
