...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/core/src/bundle/Core/DependencyInjection/Configuration/ConfigResolver/StaticSiteAccessConfigResolver.php';

class StaticSiteAccessConfigResolver_5d18502 extends \Ibexa\Bundle\Core\DependencyInjection\Configuration\ConfigResolver\StaticSiteAccessConfigResolver implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Bundle\Core\DependencyInjection\Configuration\ConfigResolver\StaticSiteAccessConfigResolver|null wrapped object, if the proxy is initialized
     */
...
return;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->container, $instance->siteAccessProvider, $instance->currentSiteAccess, $instance->defaultScope, $instance->defaultNamespace);
    ...
    public function __construct(\Ibexa\Core\MVC\Symfony\SiteAccess\SiteAccessProviderInterface $siteAccessProvider, string $defaultNamespace)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Bundle\\Core\\DependencyInjection\\Configuration\\ConfigResolver\\StaticSiteAccessConfigResolver');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->container, $this->siteAccessProvider, $this->currentSiteAccess, $this->defaultScope, $this->defaultNamespace);

        }

        $this->valueHolder3c8ba->__construct($siteAccessProvider, $defaultNamespace);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Bundle\\Core\\DependencyInjection\\Configuration\\ConfigResolver\\StaticSiteAccessConfigResolver');
...
if (!\class_exists('StaticSiteAccessConfigResolver_5d18502', false)) {
    \class_alias(__NAMESPACE__.'\\StaticSiteAccessConfigResolver_5d18502', 'StaticSiteAccessConfigResolver_5d18502', false);
}
