...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            yield 'cache.tagaware.filesystem' => ($container->services['cache.tagaware.filesystem'] ?? $container->getCache_Tagaware_FilesystemService());
            ...
            yield '.site_factory_pool.inner' => ($container->privates['.site_factory_pool.inner'] ?? $container->get_SiteFactoryPool_InnerService());
            ...
            yield 'cache.doctrine.orm.ibexa_default.result' => ($container->privates['cache.doctrine.orm.ibexa_default.result'] ?? $container->getCache_Doctrine_Orm_IbexaDefault_ResultService());
            yield 'cache.doctrine.orm.ibexa_default.query' => ($container->privates['cache.doctrine.orm.ibexa_default.query'] ?? $container->getCache_Doctrine_Orm_IbexaDefault_QueryService());
