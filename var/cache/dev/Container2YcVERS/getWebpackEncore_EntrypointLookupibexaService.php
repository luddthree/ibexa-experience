 ...
 */
class getWebpackEncore_EntrypointLookupibexaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'webpack_encore.entrypoint_lookup[ibexa]' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[ibexa]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/assets/ibexa/build/entrypoints.json'), NULL, 'ibexa', true);
    }
}
