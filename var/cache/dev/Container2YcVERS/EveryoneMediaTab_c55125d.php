...
class EveryoneMediaTab_c55125d extends \Ibexa\AdminUi\Tab\Dashboard\EveryoneMediaTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\Dashboard\EveryoneMediaTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\AdminUi\Tab\Dashboard\PagerLocationToDataMapper $pagerLocationToDataMapper, \Ibexa\Contracts\Core\Repository\SearchService $searchService, \Ibexa\Core\QueryType\QueryType $mediaLocationSubtreeQueryType)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\Dashboard\\EveryoneMediaTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\Dashboard\\EveryoneMediaTab');
...
if (!\class_exists('EveryoneMediaTab_c55125d', false)) {
    \class_alias(__NAMESPACE__.'\\EveryoneMediaTab_c55125d', 'EveryoneMediaTab_c55125d', false);
}
