 ...
 */
class getIbexa_ProductCatalog_Attribute_Gateway_IntegerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.product_catalog.attribute.gateway.integer' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Local/Persistence/Legacy/Attribute/Integer/StorageDefinition.php';
        ...
        if (isset($container->privates['ibexa.product_catalog.attribute.gateway.integer'])) {
            return $container->privates['ibexa.product_catalog.attribute.gateway.integer'];
        }

        return $container->privates['ibexa.product_catalog.attribute.gateway.integer'] = new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Inheritance\Gateway(($container->services['ibexa.persistence.connection'] ?? $container->getIbexa_Persistence_ConnectionService()), $a, new RewindableGenerator(function () use ($container) {
        ...
        }, 8), new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Integer\StorageDefinition(), [0 => 'integer']);
    }
}
