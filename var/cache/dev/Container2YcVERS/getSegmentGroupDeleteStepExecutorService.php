 ...
 */
class getSegmentGroupDeleteStepExecutorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Ibexa\Segmentation\StepExecutor\SegmentGroupDeleteStepExecutor' shared autowired service.
     *
     * @return \Ibexa\Segmentation\StepExecutor\SegmentGroupDeleteStepExecutor
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/segmentation/src/lib/StepExecutor/SegmentGroupDeleteStepExecutor.php';

        $container->privates['Ibexa\\Segmentation\\StepExecutor\\SegmentGroupDeleteStepExecutor'] = $instance = new \Ibexa\Segmentation\StepExecutor\SegmentGroupDeleteStepExecutor(($container->privates['Ibexa\\Segmentation\\Service\\Event\\SegmentationServiceEventDecorator'] ?? $container->getSegmentationServiceEventDecoratorService()));
        ...
        $instance->setContainer(($container->privates['.service_locator.HCnby4J'] ?? $container->load('get_ServiceLocator_HCnby4JService'))->withContext('Ibexa\\Segmentation\\StepExecutor\\SegmentGroupDeleteStepExecutor', $container));
