...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Tab/Product/PricesTab.php';

class PricesTab_452e56c extends \Ibexa\ProductCatalog\Tab\Product\PricesTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\PricesTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\PricesTab $instance) {
            unset($instance->currencyService, $instance->priceService, $instance->formFactory, $instance->customerGroupService, $instance->configResolver, $instance->requestStack);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Product\\PricesTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\CurrencyServiceInterface $currencyService, \Ibexa\Contracts\ProductCatalog\ProductPriceServiceInterface $priceService, \Ibexa\Contracts\ProductCatalog\CustomerGroupServiceInterface $customerGroupService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\Core\SiteAccess\ConfigResolverInterface $configResolver, \Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\PricesTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\PricesTab $instance) {
            unset($instance->currencyService, $instance->priceService, $instance->formFactory, $instance->customerGroupService, $instance->configResolver, $instance->requestStack);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\Product\\PricesTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $currencyService, $priceService, $customerGroupService, $formFactory, $configResolver, $requestStack);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\PricesTab');
...
if (!\class_exists('PricesTab_452e56c', false)) {
    \class_alias(__NAMESPACE__.'\\PricesTab_452e56c', 'PricesTab_452e56c', false);
}
