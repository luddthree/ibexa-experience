...
class DetailsTab_1ce0b6a extends \Ibexa\ProductCatalog\Tab\CustomerGroup\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\CustomerGroup\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\CustomerGroup\\DetailsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\CustomerGroup\\DetailsTab');
...
if (!\class_exists('DetailsTab_1ce0b6a', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_1ce0b6a', 'DetailsTab_1ce0b6a', false);
}
