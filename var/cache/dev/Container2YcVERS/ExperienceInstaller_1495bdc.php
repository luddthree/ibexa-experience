...
class ExperienceInstaller_1495bdc extends \Ibexa\Installer\Installer\ExperienceInstaller implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Installer\Installer\ExperienceInstaller|null wrapped object, if the proxy is initialized
     */
...
return;
    ...
    public function __construct(\Doctrine\DBAL\Connection $db, \Ibexa\Contracts\DoctrineSchema\Builder\SchemaBuilderInterface $schemaBuilder, iterable $provisioners)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Installer\\Installer\\ExperienceInstaller');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Installer\\Installer\\ExperienceInstaller');
...
if (!\class_exists('ExperienceInstaller_1495bdc', false)) {
    \class_alias(__NAMESPACE__.'\\ExperienceInstaller_1495bdc', 'ExperienceInstaller_1495bdc', false);
}
