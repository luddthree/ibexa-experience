...
class DetailsTab_f0d00fc extends \Ibexa\ProductCatalog\Tab\Catalog\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Catalog\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Catalog\\DetailsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Catalog\\DetailsTab');
...
if (!\class_exists('DetailsTab_f0d00fc', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_f0d00fc', 'DetailsTab_f0d00fc', false);
}
