...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Tab/ProductType/DetailsTab.php';

class DetailsTab_9e3aa1c extends \Ibexa\ProductCatalog\Tab\ProductType\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\ProductType\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\ProductType\DetailsTab $instance) {
            unset($instance->formFactory, $instance->productTypeService, $instance->requestStack, $instance->fieldDefinitionGroupsUtil, $instance->regionService);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\ProductType\\DetailsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\ProductTypeServiceInterface $productTypeService, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Symfony\Component\HttpFoundation\RequestStack $requestStack, \Ibexa\AdminUi\Util\FieldDefinitionGroupsUtil $fieldDefinitionGroupsUtil, \Ibexa\Contracts\ProductCatalog\RegionServiceInterface $regionService)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\ProductType\\DetailsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\ProductType\DetailsTab $instance) {
            unset($instance->formFactory, $instance->productTypeService, $instance->requestStack, $instance->fieldDefinitionGroupsUtil, $instance->regionService);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\ProductType\\DetailsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $productTypeService, $formFactory, $requestStack, $fieldDefinitionGroupsUtil, $regionService);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\ProductType\\DetailsTab');
...
if (!\class_exists('DetailsTab_9e3aa1c', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_9e3aa1c', 'DetailsTab_9e3aa1c', false);
}
