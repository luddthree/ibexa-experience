 ...
 */
class getSegmentViewControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'Ibexa\Bundle\Segmentation\Controller\REST\Segment\SegmentViewController' shared autowired service.
     *
     * @return \Ibexa\Bundle\Segmentation\Controller\REST\Segment\SegmentViewController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/segmentation/src/bundle/Controller/REST/Segment/SegmentViewController.php';

        $container->services['Ibexa\\Bundle\\Segmentation\\Controller\\REST\\Segment\\SegmentViewController'] = $instance = new \Ibexa\Bundle\Segmentation\Controller\REST\Segment\SegmentViewController(($container->privates['Ibexa\\Segmentation\\Service\\Event\\SegmentationServiceEventDecorator'] ?? $container->getSegmentationServiceEventDecoratorService()));
