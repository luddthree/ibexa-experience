...
class TranslationTab_490d53a extends \Ibexa\ProductCatalog\Tab\ProductType\TranslationTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\ProductType\TranslationTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\PermissionResolverInterface $permissionResolver, \Ibexa\Contracts\Core\Repository\LanguageService $languageService, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\ProductType\\TranslationTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\ProductType\\TranslationTab');
...
if (!\class_exists('TranslationTab_490d53a', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationTab_490d53a', 'TranslationTab_490d53a', false);
}
