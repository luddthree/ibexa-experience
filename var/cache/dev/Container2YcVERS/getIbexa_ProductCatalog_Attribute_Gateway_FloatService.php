 ...
 */
class getIbexa_ProductCatalog_Attribute_Gateway_FloatService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.product_catalog.attribute.gateway.float' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Local/Persistence/Legacy/Attribute/Float/StorageDefinition.php';
        ...
        if (isset($container->privates['ibexa.product_catalog.attribute.gateway.float'])) {
            return $container->privates['ibexa.product_catalog.attribute.gateway.float'];
        }

        return $container->privates['ibexa.product_catalog.attribute.gateway.float'] = new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Inheritance\Gateway(($container->services['ibexa.persistence.connection'] ?? $container->getIbexa_Persistence_ConnectionService()), $a, new RewindableGenerator(function () use ($container) {
        ...
        }, 8), new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Float\StorageDefinition(), [0 => 'float']);
    }
}
