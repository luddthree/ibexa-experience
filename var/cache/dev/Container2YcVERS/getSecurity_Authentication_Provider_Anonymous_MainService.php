...
class getSecurity_Authentication_Provider_Anonymous_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.authentication.provider.anonymous.main'] = $instance = new \Ibexa\Core\MVC\Symfony\Security\Authentication\AnonymousAuthenticationProvider($container->getParameter('container.build_hash'));
