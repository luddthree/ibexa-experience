...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/core/src/lib/FieldType/Image/IO/Legacy.php';

class Legacy_c3c83ff extends \Ibexa\Core\FieldType\Image\IO\Legacy implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Core\FieldType\Image\IO\Legacy|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\Core\FieldType\Image\IO\Legacy $instance) {
            unset($instance->publishedIOService, $instance->draftIOService, $instance->publishedPrefix, $instance->draftPrefix, $instance->optionsProvider);
        }, $instance, 'Ibexa\\Core\\FieldType\\Image\\IO\\Legacy')->__invoke($instance);
    ...
    public function __construct(\Ibexa\Core\IO\IOServiceInterface $publishedIOService, \Ibexa\Core\IO\IOServiceInterface $draftIOService, \Ibexa\Core\FieldType\Image\IO\OptionsProvider $optionsProvider)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Core\\FieldType\\Image\\IO\\Legacy');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Ibexa\Core\FieldType\Image\IO\Legacy $instance) {
            unset($instance->publishedIOService, $instance->draftIOService, $instance->publishedPrefix, $instance->draftPrefix, $instance->optionsProvider);
        }, $this, 'Ibexa\\Core\\FieldType\\Image\\IO\\Legacy')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($publishedIOService, $draftIOService, $optionsProvider);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Core\\FieldType\\Image\\IO\\Legacy');
...
if (!\class_exists('Legacy_c3c83ff', false)) {
    \class_alias(__NAMESPACE__.'\\Legacy_c3c83ff', 'Legacy_c3c83ff', false);
}
