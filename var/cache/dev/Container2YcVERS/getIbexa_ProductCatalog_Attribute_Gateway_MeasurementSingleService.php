 ...
 */
class getIbexa_ProductCatalog_Attribute_Gateway_MeasurementSingleService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ibexa.product_catalog.attribute.gateway.measurement_single' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/measurement/src/lib/ProductCatalog/Local/Attribute/SingleMeasurementStorageDefinition.php';
        ...
        if (isset($container->privates['ibexa.product_catalog.attribute.gateway.measurement_single'])) {
            return $container->privates['ibexa.product_catalog.attribute.gateway.measurement_single'];
        }

        return $container->privates['ibexa.product_catalog.attribute.gateway.measurement_single'] = new \Ibexa\ProductCatalog\Local\Persistence\Legacy\Attribute\Inheritance\Gateway(($container->services['ibexa.persistence.connection'] ?? $container->getIbexa_Persistence_ConnectionService()), $a, new RewindableGenerator(function () use ($container) {
        ...
        }, 8), new \Ibexa\Measurement\ProductCatalog\Local\Attribute\SingleMeasurementStorageDefinition(), [0 => 'measurement_single']);
    }
}
