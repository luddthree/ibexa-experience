...
include_once \dirname(__DIR__, 4).'/vendor/ibexa/product-catalog/src/lib/Tab/AttributeDefinition/TranslationsTab.php';

class TranslationsTab_4d54231 extends \Ibexa\ProductCatalog\Tab\AttributeDefinition\TranslationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\AttributeDefinition\TranslationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->formFactory, $instance->permissionResolver, $instance->languageService, $instance->urlGenerator, $instance->eventDispatcher, $instance->twig, $instance->translator);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\PermissionResolverInterface $permissionResolver, \Ibexa\Contracts\Core\Repository\LanguageService $languageService, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeDefinition\\TranslationsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->formFactory, $this->permissionResolver, $this->languageService, $this->urlGenerator, $this->eventDispatcher, $this->twig, $this->translator);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $formFactory, $permissionResolver, $languageService, $urlGenerator);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeDefinition\\TranslationsTab');
...
if (!\class_exists('TranslationsTab_4d54231', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationsTab_4d54231', 'TranslationsTab_4d54231', false);
}
