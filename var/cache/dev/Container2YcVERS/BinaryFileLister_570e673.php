...
class BinaryFileLister_570e673 extends \Ibexa\Bundle\IO\Migration\FileLister\BinaryFileLister implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Bundle\IO\Migration\FileLister\BinaryFileLister|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\Bundle\IO\Migration\FileLister\BinaryFileLister $instance) {
            unset($instance->fileList, $instance->filesDir);
        }, $instance, 'Ibexa\\Bundle\\IO\\Migration\\FileLister\\BinaryFileLister')->__invoke($instance);
    ...
    public function __construct(\Ibexa\Bundle\IO\ApiLoader\HandlerRegistry $metadataHandlerRegistry, \Ibexa\Bundle\IO\ApiLoader\HandlerRegistry $binarydataHandlerRegistry, ?\Psr\Log\LoggerInterface $logger, \Iterator $fileList, $filesDir)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Bundle\\IO\\Migration\\FileLister\\BinaryFileLister');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->fromMetadataHandler, $this->fromBinarydataHandler, $this->toMetadataHandler, $this->toBinarydataHandler);

        \Closure::bind(function (\Ibexa\Bundle\IO\Migration\FileLister\BinaryFileLister $instance) {
            unset($instance->fileList, $instance->filesDir);
        }, $this, 'Ibexa\\Bundle\\IO\\Migration\\FileLister\\BinaryFileLister')->__invoke($this);
        ...
        $this->valueHolder3c8ba->__construct($metadataHandlerRegistry, $binarydataHandlerRegistry, $logger, $fileList, $filesDir);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Bundle\\IO\\Migration\\FileLister\\BinaryFileLister');
...
if (!\class_exists('BinaryFileLister_570e673', false)) {
    \class_alias(__NAMESPACE__.'\\BinaryFileLister_570e673', 'BinaryFileLister_570e673', false);
}
