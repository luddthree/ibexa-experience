 ...
 */
class getContentDeleteStepExecutorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Ibexa\Migration\StepExecutor\ContentDeleteStepExecutor' shared autowired service.
     *
     * @return \Ibexa\Migration\StepExecutor\ContentDeleteStepExecutor
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/migrations/src/lib/StepExecutor/ContentDeleteStepExecutor.php';
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/migrations/src/lib/StepExecutor/ActionExecutor/Content/Delete/Executor.php';

        $container->privates['Ibexa\\Migration\\StepExecutor\\ContentDeleteStepExecutor'] = $instance = new \Ibexa\Migration\StepExecutor\ContentDeleteStepExecutor(($container->services['ibexa.api.service.content'] ?? $container->getIbexa_Api_Service_ContentService()), new \Ibexa\Migration\StepExecutor\ActionExecutor\Content\Delete\Executor(($container->privates['.service_locator.m7TxS0i'] ?? $container->load('get_ServiceLocator_M7TxS0iService'))), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()));
        ...
        $instance->setContainer(($container->privates['.service_locator.HVzuLil'] ?? $container->load('get_ServiceLocator_HVzuLilService'))->withContext('Ibexa\\Migration\\StepExecutor\\ContentDeleteStepExecutor', $container));
