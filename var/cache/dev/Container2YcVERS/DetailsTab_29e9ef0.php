...
class DetailsTab_29e9ef0 extends \Ibexa\ProductCatalog\Tab\AttributeGroup\DetailsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\AttributeGroup\DetailsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\DetailsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\AttributeGroup\\DetailsTab');
...
if (!\class_exists('DetailsTab_29e9ef0', false)) {
    \class_alias(__NAMESPACE__.'\\DetailsTab_29e9ef0', 'DetailsTab_29e9ef0', false);
}
