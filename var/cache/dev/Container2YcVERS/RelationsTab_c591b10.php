...
class RelationsTab_c591b10 extends \Ibexa\AdminUi\Tab\LocationView\RelationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\AdminUi\Tab\LocationView\RelationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->permissionResolver, $instance->datasetFactory, $instance->contentTypeService, $instance->eventDispatcher, $instance->twig, $instance->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\RelationsTab $instance) {
            unset($instance->contentService);
        }, $instance, 'Ibexa\\AdminUi\\Tab\\LocationView\\RelationsTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\Contracts\Core\Repository\PermissionResolver $permissionResolver, \Ibexa\AdminUi\UI\Dataset\DatasetFactory $datasetFactory, \Ibexa\Contracts\Core\Repository\ContentTypeService $contentTypeService, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\Core\Repository\ContentService $contentService)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\RelationsTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->permissionResolver, $this->datasetFactory, $this->contentTypeService, $this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\AdminUi\Tab\LocationView\RelationsTab $instance) {
            unset($instance->contentService);
        }, $this, 'Ibexa\\AdminUi\\Tab\\LocationView\\RelationsTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $permissionResolver, $datasetFactory, $contentTypeService, $eventDispatcher, $contentService);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\AdminUi\\Tab\\LocationView\\RelationsTab');
...
if (!\class_exists('RelationsTab_c591b10', false)) {
    \class_alias(__NAMESPACE__.'\\RelationsTab_c591b10', 'RelationsTab_c591b10', false);
}
