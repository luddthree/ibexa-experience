...
class TranslationsTab_0b8a649 extends \Ibexa\ProductCatalog\Tab\Catalog\TranslationsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Catalog\TranslationsTab|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Symfony\Component\Form\FormFactoryInterface $formFactory, \Ibexa\Contracts\ProductCatalog\PermissionResolverInterface $permissionResolver, \Ibexa\Contracts\Core\Repository\LanguageService $languageService, \Symfony\Component\Routing\Generator\UrlGeneratorInterface $urlGenerator)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Catalog\\TranslationsTab');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Catalog\\TranslationsTab');
...
if (!\class_exists('TranslationsTab_0b8a649', false)) {
    \class_alias(__NAMESPACE__.'\\TranslationsTab_0b8a649', 'TranslationsTab_0b8a649', false);
}
