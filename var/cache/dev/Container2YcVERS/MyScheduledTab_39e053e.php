...
class MyScheduledTab_39e053e extends \Ibexa\Scheduler\Dashboard\MyScheduledTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\Scheduler\Dashboard\MyScheduledTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\Scheduler\Dashboard\MyScheduledTab $instance) {
            unset($instance->userService);
        }, $instance, 'Ibexa\\Scheduler\\Dashboard\\MyScheduledTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Ibexa\Contracts\Core\Repository\ContentService $contentService, \Ibexa\Contracts\Core\Repository\ContentTypeService $contentTypeService, \Ibexa\Contracts\Scheduler\Repository\DateBasedPublishServiceInterface $dateBasedPublisherService, \Ibexa\Contracts\Core\Repository\UserService $userService, \Ibexa\Core\Helper\TranslationHelper $translationHelper)
    {
        ...
        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\Scheduler\\Dashboard\\MyScheduledTab');
        ...
        \Closure::bind(function (\Ibexa\Scheduler\Dashboard\MyScheduledTab $instance) {
            unset($instance->userService);
        }, $this, 'Ibexa\\Scheduler\\Dashboard\\MyScheduledTab')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\Scheduler\\Dashboard\\MyScheduledTab');
...
if (!\class_exists('MyScheduledTab_39e053e', false)) {
    \class_alias(__NAMESPACE__.'\\MyScheduledTab_39e053e', 'MyScheduledTab_39e053e', false);
}
