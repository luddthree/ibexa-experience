...
class AvailabilityTab_73e5481 extends \Ibexa\ProductCatalog\Tab\Product\AvailabilityTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\AvailabilityTab|null wrapped object, if the proxy is initialized
     */
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\AvailabilityTab $instance) {
            unset($instance->availabilityService);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Product\\AvailabilityTab')->__invoke($instance);
    ...
    public function __construct(\Twig\Environment $twig, \Symfony\Contracts\Translation\TranslatorInterface $translator, \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \Ibexa\Contracts\ProductCatalog\ProductAvailabilityServiceInterface $availabilityService)
    {
        static $reflection;

        if (! $this->valueHolder3c8ba) {
            $reflection = $reflection ?? new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\AvailabilityTab');
            $this->valueHolder3c8ba = $reflection->newInstanceWithoutConstructor();
        unset($this->eventDispatcher, $this->twig, $this->translator);

        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\AvailabilityTab $instance) {
            unset($instance->availabilityService);
        }, $this, 'Ibexa\\ProductCatalog\\Tab\\Product\\AvailabilityTab')->__invoke($this);

        }

        $this->valueHolder3c8ba->__construct($twig, $translator, $eventDispatcher, $availabilityService);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\AvailabilityTab');
...
if (!\class_exists('AvailabilityTab_73e5481', false)) {
    \class_alias(__NAMESPACE__.'\\AvailabilityTab_73e5481', 'AvailabilityTab_73e5481', false);
}
