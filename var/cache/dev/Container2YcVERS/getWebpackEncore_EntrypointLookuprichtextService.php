 ...
 */
class getWebpackEncore_EntrypointLookuprichtextService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'webpack_encore.entrypoint_lookup[richtext]' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[richtext]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/assets/richtext/build/entrypoints.json'), NULL, 'richtext', true);
    }
}
