 ...
 */
class getViewsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'Ibexa\Rest\Server\Controller\Views' shared autowired service.
     *
     * @return \Ibexa\Rest\Server\Controller\Views
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller.php';
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/rest/src/lib/Server/Controller/Views.php';

        $container->services['Ibexa\\Rest\\Server\\Controller\\Views'] = $instance = new \Ibexa\Rest\Server\Controller\Views(($container->services['ibexa.api.service.search'] ?? $container->getIbexa_Api_Service_SearchService()));
