 ...
 */
class getContentTypeGroupUpdateStepExecutorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Ibexa\Migration\StepExecutor\ContentTypeGroupUpdateStepExecutor' shared autowired service.
     *
     * @return \Ibexa\Migration\StepExecutor\ContentTypeGroupUpdateStepExecutor
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/ibexa/migrations/src/lib/StepExecutor/ContentTypeGroupUpdateStepExecutor.php';

        $container->privates['Ibexa\\Migration\\StepExecutor\\ContentTypeGroupUpdateStepExecutor'] = $instance = new \Ibexa\Migration\StepExecutor\ContentTypeGroupUpdateStepExecutor(($container->services['ibexa.api.repository'] ?? $container->getIbexa_Api_RepositoryService()), ($container->services['ibexa.api.service.content_type'] ?? $container->getIbexa_Api_Service_ContentTypeService()), ($container->services['ibexa.api.service.user'] ?? $container->getIbexa_Api_Service_UserService()), 'admin', ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()));
