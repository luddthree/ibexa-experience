...
class VariantsTab_86b2e78 extends \Ibexa\ProductCatalog\Tab\Product\VariantsTab implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Ibexa\ProductCatalog\Tab\Product\VariantsTab|null wrapped object, if the proxy is initialized
     */
    ...
    {
        $this->initializerf0d6f && ($this->initializerf0d6f->__invoke($valueHolder3c8ba, $this, 'getTemplateParameters', array('parameters' => $parameters), $this->initializerf0d6f) || 1) && $this->valueHolder3c8ba = $valueHolder3c8ba;

        return $this->valueHolder3c8ba->getTemplateParameters($parameters);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Ibexa\ProductCatalog\Tab\Product\VariantsTab $instance) {
            unset($instance->productService, $instance->requestStack, $instance->formFactory, $instance->urlGenerator);
        }, $instance, 'Ibexa\\ProductCatalog\\Tab\\Product\\VariantsTab')->__invoke($instance);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Ibexa\\ProductCatalog\\Tab\\Product\\VariantsTab');
...
if (!\class_exists('VariantsTab_86b2e78', false)) {
    \class_alias(__NAMESPACE__.'\\VariantsTab_86b2e78', 'VariantsTab_86b2e78', false);
}
