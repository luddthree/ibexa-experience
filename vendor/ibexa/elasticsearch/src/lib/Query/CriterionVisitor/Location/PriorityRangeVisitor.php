...
final class PriorityRangeVisitor extends AbstractRangeVisitor
{
    public function supports(Criterion $criterion, LanguageFilter $languageFilter): bool
    {
        return $criterion instanceof Priority && $this->isRangeOperator($criterion->operator);
    }
...
class_alias(PriorityRangeVisitor::class, 'Ibexa\Platform\ElasticSearchEngine\Query\CriterionVisitor\Location\PriorityRangeVisitor');
