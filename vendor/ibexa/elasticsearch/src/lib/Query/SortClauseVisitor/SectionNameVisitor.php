...
final class SectionNameVisitor extends AbstractSortClauseVisitor
{
    ...
    {
        return [
            'section_name_s' => $this->getDirection($sortClause),
        ];
    }
}

class_alias(SectionNameVisitor::class, 'Ibexa\Platform\ElasticSearchEngine\Query\SortClauseVisitor\SectionNameVisitor');
