...
use Ibexa\Contracts\Core\Repository\Values\Content\Query\SortClause\Location\Visibility;
...
final class VisibilityVisitor extends AbstractSortClauseVisitor
{
    ...
    {
        return [
            'invisible_b' => $this->getDirection($sortClause),
        ];
    }
}

class_alias(VisibilityVisitor::class, 'Ibexa\Platform\ElasticSearchEngine\Query\SortClauseVisitor\Location\VisibilityVisitor');
