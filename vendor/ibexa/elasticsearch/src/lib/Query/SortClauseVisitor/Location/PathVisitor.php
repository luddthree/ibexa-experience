...
final class PathVisitor extends AbstractSortClauseVisitor
{
    ...
    {
        return [
            'path_string_id' => $this->getDirection($sortClause),
        ];
    }
}

class_alias(PathVisitor::class, 'Ibexa\Platform\ElasticSearchEngine\Query\SortClauseVisitor\Location\PathVisitor');
