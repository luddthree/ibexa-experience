...
final class ContentIdVisitor extends AbstractSortClauseVisitor
{
    ...
    {
        return [
            'content_id_id' => $this->getDirection($sortClause),
        ];
    }
}

class_alias(ContentIdVisitor::class, 'Ibexa\Platform\ElasticSearchEngine\Query\SortClauseVisitor\ContentIdVisitor');
