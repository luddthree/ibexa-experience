...
trait CoreSetupFactoryTrait
{
    ...
    protected function loadCoreSettings(ContainerBuilder $containerBuilder)
    {
        ...
        $loader = new YamlFileLoader(
            $containerBuilder,
            new FileLocator("{$kernelRootDir}/src/lib/Resources/settings")
        );
        ...
        $loader = new YamlFileLoader(
            $containerBuilder,
            new FileLocator("{$kernelRootDir}/tests/integration/Core/Resources/settings")
        );

        $loader->load('common.yml');
        $loader->load('integration_legacy.yml');

        // /home/adamwojs/ibexa/elastic-search-engine/vendor/ibexa/core/tests/integration/Core/Resources/settings
