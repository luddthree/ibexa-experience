...
final class DateRangeAggregationVisitorTest extends AbstractAggregationVisitorTest
{
        ...
        yield 'typical' => [
            ...
            [
                'date_range' => [
                    ...
                    'ranges' => [
                        [
                            'to' => '2018-01-01T00:00:00+0000',
                        ],
                        [
                            'from' => '2018-01-01T00:00:00+0000',
                            'to' => '2019-01-01T00:00:00+0000',
                        ],
                        [
                            'from' => '2019-01-01T00:00:00+0000',
                        ],
                    ],
                ],
            ],
    ...
    {
        return new DateRangeAggregationVisitor(AbstractRangeAggregation::class, $this->fieldResolver);
    }
}

class_alias(DateRangeAggregationVisitorTest::class, 'Ibexa\Platform\ElasticSearchEngine\Tests\Query\AggregationVisitor\DateRangeAggregationVisitorTest');
