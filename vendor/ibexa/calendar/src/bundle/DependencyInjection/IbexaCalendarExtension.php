...
namespace Ibexa\Bundle\Calendar\DependencyInjection;
...
final class IbexaCalendarExtension extends Extension implements PrependExtensionInterface
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $loader->load('services/rest.yaml');
    }
...
class_alias(IbexaCalendarExtension::class, 'EzSystems\EzPlatformCalendarBundle\DependencyInjection\EzPlatformCalendarExtension');
