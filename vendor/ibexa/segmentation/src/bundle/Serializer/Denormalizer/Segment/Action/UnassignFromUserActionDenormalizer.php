 ...
 *     \Ibexa\Segmentation\Value\Step\Action\Segment\UnassignFromUser
 * >
 */
final class UnassignFromUserActionDenormalizer extends AbstractUserActionDenormalizer implements DenormalizerAwareInterface
{
    protected function supportsActionName(string $actionName, string $format = null): bool
    {
        return $actionName === UnassignFromUser::TYPE;
    }
     ...
     *
     * @return \Ibexa\Segmentation\Value\Step\Action\Segment\UnassignFromUser
     */
    public function denormalize($data, string $type, string $format = null, array $context = [])
    {
        return $this->getActionStep($data, UnassignFromUser::class);
    }
}
