...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\Query\Criterion\ColorAttribute;
...
final class ColorAttributeTest extends TestCase
{
    private ColorAttribute $parser;

    protected function setUp(): void
    {
        $this->parser = new ColorAttribute();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new ColorAttributeCriterion('foo', ['#123456', '#000FFF']),
            $this->parser->parse(
                [
    ...
    {
        yield [
            'Invalid <ColorAttributeCriterion>',
            [
                'identifier' => 'test',
                'bar' => 'foo',
            ],
