...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\Query\Criterion\AttributeName;
...
{
    private AttributeName $parser;

    protected function setUp(): void
    {
        $this->parser = new AttributeName();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new NameCriterion('test_name'),
            $this->parser->parse(
                ['AttributeNameCriterion' => 'test_name'],
    ...
    {
        yield [
            'Invalid <AttributeNameCriterion>',
            [
                'bar' => 'foo',
            ],
        ];
