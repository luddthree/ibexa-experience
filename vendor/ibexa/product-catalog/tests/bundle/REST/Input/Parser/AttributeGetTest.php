...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\AttributeGet;
use Ibexa\Bundle\ProductCatalog\REST\Value\AttributeLanguageStruct;
use Ibexa\Contracts\Rest\Exceptions\Parser;
use Ibexa\Contracts\Rest\Input\ParsingDispatcher;
use PHPUnit\Framework\TestCase;

final class AttributeGetTest extends TestCase
{
    private AttributeGet $parser;

    protected function setUp(): void
    {
        $this->parser = new AttributeGet();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new AttributeLanguageStruct(['eng-GB', 'pol-PL']),
            $this->parser->parse(
                [
