...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\Query\Criterion\AttributeGroupIdentifier;
...
final class AttributeGroupIdentifierTest extends TestCase
{
    private AttributeGroupIdentifier $parser;

    protected function setUp(): void
    {
        $this->parser = new AttributeGroupIdentifier();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new AttributeGroupIdentifierCriterion('test_identifier'),
            $this->parser->parse(
                ['AttributeGroupIdentifierCriterion' => 'test_identifier'],
    ...
    {
        yield [
            'Invalid <AttributeGroupIdentifierCriterion>',
            [
                'bar' => 'foo',
            ],
        ];
