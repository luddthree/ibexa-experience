...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\Query\Criterion\ProductAvailability;
...
{
    private ProductAvailability $parser;

    protected function setUp(): void
    {
        $this->parser = new ProductAvailability();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new ProductAvailabilityCriterion(true),
            $this->parser->parse(
    ...
    {
        yield [
            'Invalid <ProductAvailabilityCriterion>',
            [
                'bar' => 'foo',
            ],
        ];
