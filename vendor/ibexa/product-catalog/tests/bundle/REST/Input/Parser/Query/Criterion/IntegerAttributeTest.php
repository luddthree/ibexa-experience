...
use Ibexa\Bundle\ProductCatalog\REST\Input\Parser\Query\Criterion\IntegerAttribute;
...
{
    private IntegerAttribute $parser;

    protected function setUp(): void
    {
        $this->parser = new IntegerAttribute();
    }

    public function testValidInput(): void
    {
        self::assertEquals(
            new IntegerAttributeCriterion('foo', 1),
            $this->parser->parse(
                [
    ...
    {
        yield [
            'Invalid <IntegerAttributeCriterion>',
            [
                'identifier' => 'test',
                'bar' => 'foo',
            ],
