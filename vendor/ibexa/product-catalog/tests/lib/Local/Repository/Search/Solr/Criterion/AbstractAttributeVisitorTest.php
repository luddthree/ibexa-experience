...
namespace Ibexa\Tests\ProductCatalog\Local\Repository\Search\Solr\Criterion;
...
/**
 * @covers \Ibexa\ProductCatalog\Local\Repository\Search\Solr\Criterion\AbstractAttributeVisitor
 */
final class AbstractAttributeVisitorTest extends TestCase
{
     ...
     * } $options
     */
    public function testVisit($value, array $options, string $expectedResult): void
    {
     ...
     * } $options
     *
     * @return \Ibexa\ProductCatalog\Local\Repository\Search\Solr\Criterion\AbstractAttributeVisitor<
