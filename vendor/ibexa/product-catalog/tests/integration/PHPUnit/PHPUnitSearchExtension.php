...
namespace Ibexa\Tests\Integration\ProductCatalog\PHPUnit;
...
final class PHPUnitSearchExtension implements AfterTestHook, AfterLastTestHook
{
    ...
    private static KernelInterface $testKernel;

    public static function setTestKernel(KernelInterface $testKernel): void
    {
