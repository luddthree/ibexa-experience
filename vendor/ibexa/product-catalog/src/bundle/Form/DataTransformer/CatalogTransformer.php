...
/**
 * @implements \Symfony\Component\Form\DataTransformerInterface<CatalogInterface, string|int>
 */
final class CatalogTransformer implements DataTransformerInterface
{
    ...
    public function reverseTransform($value): ?CatalogInterface
    {
        if (empty($value)) {
            return null;
        }
