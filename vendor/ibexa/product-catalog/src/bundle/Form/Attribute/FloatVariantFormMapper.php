...
final class FloatVariantFormMapper implements VariantFormMapperInterface
{
    public function createForm(
        ...
        $form->addModelTransformer(new StringToArrayTransformer(new NumberToLocalizedStringTransformer()));
