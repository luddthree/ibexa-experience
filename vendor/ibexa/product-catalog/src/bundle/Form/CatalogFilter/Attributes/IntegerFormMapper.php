...
use Ibexa\Bundle\ProductCatalog\Form\Type\Catalog\CatalogFilterIntegerAttributeType;
...
final class IntegerFormMapper implements FilterFormMapperInterface
{
    /**
    ...
    public function createFilterForm(
        ...
        $form = $builder->create(
            ...
            CatalogFilterIntegerAttributeType::class,
            [
                'label' => $attributeDefinition->getName(),
                'block_prefix' => 'catalog_criteria_product_attribute_integer',
        ...
        $form->addModelTransformer(
            new IntegerAttributeCriterionTransformer($attributeDefinition->getIdentifier())
        );
    ...
    public function supports(FilterDefinitionInterface $filterDefinition): bool
    {
        if ($filterDefinition instanceof ProductAttribute) {
            return $filterDefinition->getAttributeDefinition()->getType()->getIdentifier() === 'integer';
        }
