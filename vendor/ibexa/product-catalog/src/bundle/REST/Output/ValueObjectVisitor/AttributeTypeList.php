...
final class AttributeTypeList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'AttributeTypeList';
    private const OBJECT_IDENTIFIER = 'AttributeType';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\AttributeTypeList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->attributeTypes as $attributeType) {
            $visitor->visitValueObject($attributeType);
        }
