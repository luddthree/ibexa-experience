...
final class VatCategoryList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'VatCategoryList';
    private const OBJECT_IDENTIFIER = 'VatCategory';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\VatCategoryList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->vatCategories as $vatCategory) {
            $visitor->visitValueObject($vatCategory);
        }
