...
final class CatalogProductSortClauseList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'ProductSortClauseList';
    private const OBJECT_IDENTIFIER = 'ProductSortClause';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\CatalogProductSortClauseList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->sortClauses as $productSortClause) {
            $visitor->visitValueObject($productSortClause);
        }
