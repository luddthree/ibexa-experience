...
final class ProductVariantList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'ProductVariantList';
    private const OBJECT_IDENTIFIER = 'ProductVariant';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\ProductVariantList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->productVariants as $productVariant) {
            $visitor->visitValueObject($productVariant);
        }
