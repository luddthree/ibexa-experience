...
final class AttributeList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'AttributeList';
    private const OBJECT_IDENTIFIER = 'Attribute';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\AttributeList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->attributes as $attribute) {
            $visitor->visitValueObject($attribute);
        }
