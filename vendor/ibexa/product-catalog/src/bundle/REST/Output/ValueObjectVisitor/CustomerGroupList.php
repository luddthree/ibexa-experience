...
final class CustomerGroupList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'CustomerGroupList';
    private const OBJECT_IDENTIFIER = 'CustomerGroup';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\CustomerGroupList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->customerGroups as $customerGroup) {
            $visitor->visitValueObject($customerGroup);
        }
