...
final class CurrencyList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'CurrencyList';
    private const OBJECT_IDENTIFIER = 'Currency';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\CurrencyList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->currencies as $currency) {
            $visitor->visitValueObject($currency);
        }
