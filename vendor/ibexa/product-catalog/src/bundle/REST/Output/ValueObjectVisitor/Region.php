...
final class Region extends ValueObjectVisitor
{
    private const OBJECT_IDENTIFIER = 'Region';
    private const ATTRIBUTE_IDENTIFIER_ID = 'identifier';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\Region $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        $generator->valueElement(self::ATTRIBUTE_IDENTIFIER_ID, $data->region->getIdentifier());
