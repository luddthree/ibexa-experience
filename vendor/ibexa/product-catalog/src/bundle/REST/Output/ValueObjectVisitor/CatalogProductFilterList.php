...
final class CatalogProductFilterList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'ProductFilterList';
    private const OBJECT_IDENTIFIER = 'ProductFilter';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\CatalogProductFilterList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->filters as $productFilter) {
            $visitor->visitValueObject($productFilter);
        }
