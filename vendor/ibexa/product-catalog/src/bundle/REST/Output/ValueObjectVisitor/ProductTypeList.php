...
final class ProductTypeList extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'ProductTypeList';
    private const OBJECT_IDENTIFIER = 'ProductType';

    /**
     * @param \Ibexa\Bundle\ProductCatalog\REST\Value\ProductTypeList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->productTypes as $productType) {
            $visitor->visitValueObject($productType);
        }
