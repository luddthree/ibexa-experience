...
use Ibexa\Contracts\ProductCatalog\Values\Region\RegionQuery as RegionQueryValueObject;
 ...
 * >
 */
final class RegionQuery extends AbstractQuery
{
    ...
    ): RegionQueryValueObject {
        $query = new RegionQueryValueObject();
