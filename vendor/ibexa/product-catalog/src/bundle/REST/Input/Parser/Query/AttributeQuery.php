...
use Ibexa\Contracts\ProductCatalog\Values\AttributeDefinition\AttributeDefinitionQuery as AttributeDefinitionQueryValueObject;
 ...
 * >
 */
final class AttributeQuery extends AbstractQuery
{
    /**
     * @return string[]
     */
    ...
    ): AttributeDefinitionQueryValueObject {
        $query = new AttributeDefinitionQueryValueObject();
