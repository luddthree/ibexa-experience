...
final class ProductGet extends BaseParser
{
     ...
     */
    public function parse(array $data, ParsingDispatcher $parsingDispatcher): ProductLanguageStruct
    {
        ...
        return new ProductLanguageStruct($languages);
    }
}
