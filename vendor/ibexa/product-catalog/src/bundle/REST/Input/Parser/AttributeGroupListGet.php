...
final class AttributeGroupListGet extends BaseParser
{
    private const NAME_PREFIX_KEY = 'name_prefix';
    private const OFFSET_KEY = 'offset';
    private const LIMIT_KEY = 'limit';
    private const OBJECT_KEYS = [self::NAME_PREFIX_KEY, self::OFFSET_KEY, self::LIMIT_KEY];

    /**
     * @phpstan-param array<mixed> $data
     */
    public function parse(array $data, ParsingDispatcher $parsingDispatcher): AttributeGroupQueryStruct
    {
        ...
        return new AttributeGroupQueryStruct(
