...
abstract class AbstractAttributeTermAggregationParser extends AbstractTermAggregationParser
{
    /**
     ...
     */
    abstract protected function buildAttributeAggregation(array $data): AbstractTermAggregation;
}
