...
final class AttributeGroupGet extends BaseParser
{
     ...
     */
    public function parse(array $data, ParsingDispatcher $parsingDispatcher): AttributeGroupLanguageStruct
    {
        ...
        return new AttributeGroupLanguageStruct($languages);
    }
}
