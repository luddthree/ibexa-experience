...
use Ibexa\Bundle\ProductCatalog\REST\Value\BasePriceUpdateStruct;
 ...
 *     \Ibexa\Bundle\ProductCatalog\REST\Value\BasePriceUpdateStruct
 * >
 */
final class BasePriceUpdate extends AbstractParser
{
    ...
    public function doParse(array $data, ParsingDispatcher $parsingDispatcher): BasePriceUpdateStruct
    {
        ...
        return new BasePriceUpdateStruct($amount);
    }
