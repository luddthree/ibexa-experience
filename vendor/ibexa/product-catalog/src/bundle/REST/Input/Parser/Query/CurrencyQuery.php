...
use Ibexa\Contracts\ProductCatalog\Values\Currency\CurrencyQuery as CurrencyQueryValueObject;
 ...
 * >
 */
final class CurrencyQuery extends AbstractQuery
{
    ...
    ): CurrencyQueryValueObject {
        $query = new CurrencyQueryValueObject();
