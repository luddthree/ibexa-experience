...
final class UniqueProductPriceValidator extends ConstraintValidator
{
    ...
    {
        if (!$value instanceof ProductPriceCreateStruct) {
            throw new UnexpectedValueException($value, ProductPriceCreateStruct::class);
        }
        ...
        if ($price !== null) {
            $this->context->buildViolation('ibexa.product_price.price_exists')
