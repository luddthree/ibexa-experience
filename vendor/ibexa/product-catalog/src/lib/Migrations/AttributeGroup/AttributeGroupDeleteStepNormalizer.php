 ...
 * >
 */
final class AttributeGroupDeleteStepNormalizer extends AbstractStepNormalizer
{
    protected function normalizeStep(StepInterface $object, string $format = null, array $context = []): array
    {
        assert($object instanceof AttributeGroupDeleteStep);
    ...
    protected function denormalizeStep(
        ...
        return new AttributeGroupDeleteStep($criterion);
    }
