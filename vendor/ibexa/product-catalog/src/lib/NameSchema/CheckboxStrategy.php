...
final class CheckboxStrategy implements NameSchemaStrategyInterface
{
    /**
     * @param mixed $value
     */
    ...
    {
        return is_bool($value) && $value ? $attributeDefinition->getName() : '';
    }
    ...
    {
        return $attributeDefinition->getType()->getIdentifier() === 'checkbox';
    }
}
