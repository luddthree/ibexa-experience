...
final class AttributeDefinition implements ContextProviderInterface
{
    public function accept(PolicyInterface $policy): bool
    {
        return $policy->getObject() instanceof LocalAttributeDefinition;
    }
    ...
    public function getPermissionContext(PolicyInterface $policy): ContextInterface
    {
        ...
        return new Context($attributeDefinition);
    }
}
