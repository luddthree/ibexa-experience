...
final class ProductAvailabilityVisitor extends AbstractSortClauseVisitor
{
    ...
    public function visit(
        ...
        return [
            ProductSpecificationIndexDataProvider::INDEX_PRODUCT_AVAILABILITY . '_b' => $this->getDirection($sortClause),
        ];
    }
}
