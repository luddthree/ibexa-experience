...
final class CreatedAtVisitor extends SortClauseHandler
{
    ...
    /**
     * @phpstan-param ProductSortClauseAdapter<CreatedAt> $sortClause
     *
     * @return string[]
     */
    public function applySelect(QueryBuilder $query, SortClause $sortClause, int $number): array
    {
        ...
        $query->addSelect(sprintf('c.published AS %s', $column));
