 ...
 *     \Ibexa\Contracts\ProductCatalog\Values\Product\Query\Criterion\LogicalOr
 * >
 */
final class LogicalOrCriterionConverter implements CriterionConverterInterface
{
    /**
     * @param \Ibexa\Contracts\ProductCatalog\Values\Product\Query\Criterion\LogicalOr $criterion
     */
    public function convert(ProductCriterion $criterion): ContentCriterion
    {
        return new ContentCriterion\LogicalOr(array_map(
