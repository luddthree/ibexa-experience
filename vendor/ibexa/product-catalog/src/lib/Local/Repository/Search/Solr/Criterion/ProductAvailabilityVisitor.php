...
final class ProductAvailabilityVisitor extends CriterionVisitor
{
    ...
    public function visit(Criterion $criterion, CriterionVisitor $subVisitor = null): string
    {
        ...
        return ProductSpecificationIndexDataProvider::INDEX_PRODUCT_AVAILABILITY . '_b:' . $this->toString($isAvailable);
    }
}
