 ...
 *     \Ibexa\Contracts\ProductCatalog\Values\Product\Query\Criterion\CheckboxAttribute,
 * >
 */
final class CheckboxAttributeVisitor extends SingleFieldAttributeVisitor
{
    protected function getSupportedProductCriterion(): string
    {
        return CheckboxAttribute::class;
    }
    ...
    {
        return Type::getType(Types::BOOLEAN)->getBindingType();
    }
}
