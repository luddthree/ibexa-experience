 ...
 *     \Ibexa\Contracts\ProductCatalog\Values\Product\Query\Criterion\ProductType
 * >
 */
final class ProductTypeCriterionConverter implements CriterionConverterInterface
{
    public function convert(ProductCriterion $criterion): ContentCriterion
    {
        return new ContentTypeIdentifier($criterion->getTypes());
    }
}
