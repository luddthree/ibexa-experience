 ...
 *     \Ibexa\Contracts\ProductCatalog\Values\Product\Query\Criterion\MatchAll
 * >
 */
final class MatchAllCriterionConverter implements CriterionConverterInterface
{
    public function convert(ProductCriterion $criterion): ContentCriterion
    {
        return new ContentCriterion\MatchAll();
    }
}
