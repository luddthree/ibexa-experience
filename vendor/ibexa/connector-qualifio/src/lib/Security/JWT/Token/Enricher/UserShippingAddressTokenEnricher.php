...
final class UserShippingAddressTokenEnricher extends AbstractTokenEnricher
{
    private const CONTEXT = 'form';
    private const IDENTIFIER = 'shipping_address';
    ...
    public function getPayload(int $userId): array
    {
        ...
        $field = $user->getField('shipping_address');
        if ($field !== null) {
