...
final class IbexaConnectorQualifioExtension extends Extension implements PrependExtensionInterface
{
    /**
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter(
            'ibexa.qualifio.client_id',
            $config['client_id'] ?? null,
        );

        $container->setParameter(
            'ibexa.qualifio.channel',
            $config['channel'] ?? null,
        );

        $container->setParameter(
            'ibexa.qualifio.feed_url',
            $config['feed_url'] ?? null,
        );

        $container->setParameter(
            'ibexa.qualifio.variable_map',
            $config['variable_map'] ?? [],
        );
        ...
        $container->prependExtensionConfig('jms_translation', [
            'configs' => [
                'ibexa_connector_qualifio' => [
                    ...
                    'output_format' => 'xliff',
                    'extractors' => [
                        'ibexa.translation_extractor.connector.qualifio.custom_tags',
                    ],
                ],
            ],
        ]);
