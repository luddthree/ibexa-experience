...
final class RelationComparisonResult implements ComparisonResult
{
...
class_alias(RelationComparisonResult::class, 'EzSystems\EzPlatformVersionComparison\Result\FieldType\RelationComparisonResult');
