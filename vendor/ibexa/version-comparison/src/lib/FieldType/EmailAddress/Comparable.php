...
namespace Ibexa\VersionComparison\FieldType\EmailAddress;
...
class_alias(Comparable::class, 'EzSystems\EzPlatformVersionComparison\FieldType\EmailAddress\Comparable');
