    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('customer_group', ChoiceType::class, [
                ...
                'label' => /** @Desc("Customer group") */ 'corporate_account.company_search.customer_group.label',
                'required' => false,
            ])
            ->add('status', ChoiceType::class, [
                'choices' => [
                    /** @Desc("Active") */
                    'corporate_account.company_search.status.choice.active' => true,
                    /** @Desc("De-activated") */
                    'corporate_account.company_search.status.choice.deactivated' => false,
                ],
                'label' => /** @Desc("Status") */ 'corporate_account.company_search.status.label',
                'required' => false,
            ]);
    }
