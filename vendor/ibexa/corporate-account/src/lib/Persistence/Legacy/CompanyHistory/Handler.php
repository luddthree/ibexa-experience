...
final class Handler implements HandlerInterface
{
    ...
    /**
     * @return array<\Ibexa\CorporateAccount\Persistence\Values\CompanyHistory>
     */
    ...
    public function find(int $id): CompanyHistory
    {
        $row = $this->gateway->findById($id);

        if ($row === null) {
            throw new NotFoundException(CompanyHistory::class, $id);
        }
