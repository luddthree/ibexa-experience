...
final class SettingCreateStepNormalizerTest extends IbexaKernelTestCase
{
    ...
    public function testDenormalizeFailure(
        ...
        $this->serializer->deserialize($data, SettingCreateStep::class, 'yaml');
    }

    /**
     * @dataProvider provideSuccessfulData
     */
    public function testDenormalizeSuccess(string $data, SettingCreateStep $matcher): void
    {
        $result = $this->serializer->deserialize($data, SettingCreateStep::class, 'yaml');
        self::assertEquals($matcher, $result);
    }

    public function testNormalize(): void
    {
        $matcher = new SettingCreateStep('foo_group', 'foo_value', [
            'foo_key' => 'foo_value',
            'bar_key' => 'bar_value',
        ]);
    ...
    /**
     * @return iterable<array{string, \Ibexa\Migration\ValueObject\Step\SettingCreateStep}>
     */
    public function provideSuccessfulData(): iterable
    {
        yield [
            ...
            value:
                ...
                bar_key: bar_value
            YAML,
            new SettingCreateStep('foo_group', 'foo_identifier', [
                'foo_key' => 'foo_value',
                'bar_key' => 'bar_value',
            ]),
        ];
        ...
        yield [
            ...
            value: 'foo_value'
            YAML,
            new SettingCreateStep('foo_group', 'foo_identifier', 'foo_value'),
        ];
    }
