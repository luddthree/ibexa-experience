 ...
 */
final class RoleUpdateStepNormalizerTest extends AbstractSerializationTestCase
{
    ...
    {
        $source = self::loadFile(__DIR__ . '/role--update/role--update.yaml');
...
class_alias(RoleUpdateStepNormalizerTest::class, 'Ibexa\Platform\Tests\Bundle\Migration\Serializer\Normalizer\Step\RoleUpdateStepNormalizerTest');
