...
final class Executor extends AbstractExecutor
{
    ...
    protected function prepareLogMessage(Action $action, ValueObject $valueObject): ?string
    {
        ...
        return sprintf('[Step][Action] Executing update content action %s', $action->getSupportedType());
    }
}

class_alias(Executor::class, 'Ibexa\Platform\Migration\StepExecutor\ActionExecutor\Content\Update\Executor');
