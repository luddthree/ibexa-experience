...
final class CriterionFactory extends AbstractCriterionFactory
{
    ...
    {
        return [new Criterion\Visibility(Criterion\Visibility::VISIBLE)];
    }
}

class_alias(CriterionFactory::class, 'Ibexa\Platform\Migration\Generator\Content\CriterionFactory');
