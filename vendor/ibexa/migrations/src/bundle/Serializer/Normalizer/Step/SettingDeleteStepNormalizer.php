 ...
 *     \Ibexa\Migration\ValueObject\Step\SettingDeleteStep
 * >
 */
final class SettingDeleteStepNormalizer extends AbstractStepNormalizer
{
    /**
     * @param \Ibexa\Migration\ValueObject\Step\SettingDeleteStep $object
     */
    ...
    protected function denormalizeStep($data, string $type, string $format, array $context = []): StepInterface
    {
        ...
        return new SettingDeleteStep($data['group'], $data['identifier']);
    }

    public function getHandledClassType(): string
    {
        return SettingDeleteStep::class;
    }
