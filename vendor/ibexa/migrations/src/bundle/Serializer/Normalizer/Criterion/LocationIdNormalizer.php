...
final class LocationIdNormalizer extends AbstractCriterionNormalizer
{
    ...
    protected function createCriterion(array $data, string $type, ?string $format, array $context): FilteringCriterion
    {
        ...
        return new LocationId($data['value']);
    }

    public function supportsNormalization($data, string $format = null): bool
    {
        return $data instanceof LocationId;
    }
}

class_alias(LocationIdNormalizer::class, 'Ibexa\Platform\Bundle\Migration\Serializer\Normalizer\Criterion\LocationIdNormalizer');
