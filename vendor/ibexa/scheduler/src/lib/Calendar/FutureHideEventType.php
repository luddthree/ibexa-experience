...
final class FutureHideEventType implements EventTypeInterface
{
    private const EVENT_TYPE_IDENTIFIER = 'future_hide';
    ...
    {
        return $event->getScheduledEntry()->content->getName();
    }
...
class_alias(FutureHideEventType::class, 'EzSystems\DateBasedPublisher\Core\Calendar\FutureHideEventType');
