...
class AllScheduledTab extends AbstractTab implements OrderedTabInterface
{
    ...
    public function getName(): string
    {
        return /** @Desc("Scheduled") */
            $this->translator->trans('tab.name.all_scheduled', [], 'ibexa_scheduler');
    }
    ...
    public function renderView(array $parameters): string
    {
        ...
        $scheduled = $this->dateBasedPublisherService->getScheduledVersions(0, $limit);
        ...
        foreach ($pager as $scheduled) {
            ...
            try {
                ...
                // not found content skipped in the 'all scheduled' tab
                continue;
            }
        ...
        return $this->twig->render('@IbexaScheduler/dashboard/tab/all_scheduled.html.twig', [
            'data' => $data,
        ]);
    }
}

class_alias(AllScheduledTab::class, 'EzSystems\DateBasedPublisher\Core\Dashboard\AllScheduledTab');
