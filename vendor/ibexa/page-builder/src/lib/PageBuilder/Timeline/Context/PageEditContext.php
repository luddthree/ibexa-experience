...
class PageEditContext extends ContentEditContext implements PageContextInterface
{
...
class_alias(PageEditContext::class, 'EzSystems\EzPlatformPageBuilder\PageBuilder\Timeline\Context\PageEditContext');
