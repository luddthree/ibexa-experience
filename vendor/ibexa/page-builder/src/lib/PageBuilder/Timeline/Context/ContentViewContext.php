...
class ContentViewContext implements ContextInterface
{
...
class_alias(ContentViewContext::class, 'EzSystems\EzPlatformPageBuilder\PageBuilder\Timeline\Context\ContentViewContext');
