 ...
 * @internal
 */
class ContentEditBlockContext implements BlockContextInterface
{
...
class_alias(ContentEditBlockContext::class, 'EzSystems\EzPlatformPageBuilder\Block\Context\ContentEditBlockContext');
