...
class RevealDateTimeType extends AbstractType
{
    /**
...
class_alias(RevealDateTimeType::class, 'EzSystems\EzPlatformPageBuilder\Form\Type\RevealDateTimeType');
