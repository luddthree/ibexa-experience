...
/**
 * @phpstan-import-type Data from \Ibexa\ActivityLog\Persistence\ActivityLog\Object\ObjectGatewayInterface
 *
 * @extends \Ibexa\Contracts\CorePersistence\Gateway\AbstractDoctrineDatabase<Data>
 */
final class ObjectGateway extends AbstractDoctrineDatabase implements ObjectGatewayInterface
{
    ...
    protected function buildMetadata(): DoctrineSchemaMetadata
    {
        $columns = [
            ...
            StorageSchema::COLUMN_OBJECT_CLASS => Types::STRING,
        ];
    ...
    public function save(string $objectClass): int
    {
        return $this->doInsert([
            StorageSchema::COLUMN_OBJECT_CLASS => $objectClass,
        ]);
    }
}
