...
class NumberFieldMapper extends GenericFieldMapper
{
    /**
     * {@inheritdoc}
     */
...
class_alias(NumberFieldMapper::class, 'EzSystems\EzPlatformFormBuilder\FieldType\Field\Mapper\NumberFieldMapper');
