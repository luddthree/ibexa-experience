...
class SingleLineFieldMapper extends GenericFieldMapper
{
    /**
     * {@inheritdoc}
     */
...
class_alias(SingleLineFieldMapper::class, 'EzSystems\EzPlatformFormBuilder\FieldType\Field\Mapper\SingleLineFieldMapper');
