...
class CheckboxListFieldMapper extends GenericFieldMapper
{
    /**
     * {@inheritdoc}
     */
...
class_alias(CheckboxListFieldMapper::class, 'EzSystems\EzPlatformFormBuilder\FieldType\Field\Mapper\CheckboxListFieldMapper');
