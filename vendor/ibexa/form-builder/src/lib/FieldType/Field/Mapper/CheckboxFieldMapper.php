...
class CheckboxFieldMapper extends GenericFieldMapper
{
    /**
     * {@inheritdoc}
     */
...
class_alias(CheckboxFieldMapper::class, 'EzSystems\EzPlatformFormBuilder\FieldType\Field\Mapper\CheckboxFieldMapper');
