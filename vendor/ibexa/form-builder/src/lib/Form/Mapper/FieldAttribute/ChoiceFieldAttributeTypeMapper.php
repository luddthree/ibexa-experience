...
class ChoiceFieldAttributeTypeMapper implements AttributeConfigurationMapperInterface
{
    /** @var string */
...
class_alias(ChoiceFieldAttributeTypeMapper::class, 'EzSystems\EzPlatformFormBuilder\Form\Mapper\FieldAttribute\ChoiceFieldAttributeTypeMapper');
