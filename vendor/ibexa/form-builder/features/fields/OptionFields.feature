...
Feature: Form field configuration
  ...
  Scenario Outline: Create form with field with custom configuration
    ...
    Examples:
      ...
      | Checkbox Custom Form     | Checkbox            | Custom checkbox      |
      | Checkboxes Custom Form   | Checkboxes          | Custom checkboxes    |
      | Radio Custom Form        | Radio               | Custom radio         |
      | Dropdown Custom Form     | Dropdown            | Custom dropdown      |
