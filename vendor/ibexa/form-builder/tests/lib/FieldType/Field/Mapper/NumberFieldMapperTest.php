...
use Ibexa\FormBuilder\FieldType\Field\Mapper\NumberFieldMapper;
use Ibexa\FormBuilder\Form\Type\Field\NumberFieldType;
use Symfony\Component\Validator\Constraints as Assert;

class NumberFieldMapperTest extends AbstractFieldMapperTest
{
    private const FIELD_NAME = 'The number field';
    ...
    {
        return new NumberFieldMapper('number', NumberFieldType::class);
    }
...
class_alias(NumberFieldMapperTest::class, 'EzSystems\EzPlatformFormBuilder\Tests\FieldType\Field\Mapper\NumberFieldMapperTest');
