...
/**
 * @deprecated This component is deprecated and will be removed in 5.0 use Portal instead
 */
const PortalProvider = ({ children, portals }) => {
    console.warn('Component PortalProvider is deprecated and will be removed in 5.0 use Portal instead');
