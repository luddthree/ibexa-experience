...
class EmbedBlockListener implements EventSubscriberInterface
{
    ...
    {
        return [
            BlockRenderEvents::getBlockPreRenderEventName('embed') => 'onBlockPreRender',
        ];
    }
...
class_alias(EmbedBlockListener::class, 'EzSystems\EzPlatformPageFieldType\FieldType\Page\Block\Event\Listener\EmbedBlockListener');
