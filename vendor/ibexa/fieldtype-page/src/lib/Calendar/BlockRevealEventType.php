...
class BlockRevealEventType implements EventTypeInterface
{
    private const EVENT_TYPE_IDENTIFIER = 'page_block_reveal';
...
class_alias(BlockRevealEventType::class, 'EzSystems\EzPlatformPageFieldType\Calendar\BlockRevealEventType');
