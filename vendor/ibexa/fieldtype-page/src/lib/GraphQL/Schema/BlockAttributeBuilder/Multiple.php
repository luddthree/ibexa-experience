...
class Multiple implements BlockAttributeBuilder
{
    ...
    {
        $resolve = sprintf(
            '@=resolver("MultipleStorageValue", [value.getAttribute("%s").getValue()])',
...
class_alias(Multiple::class, 'EzSystems\EzPlatformPageFieldType\GraphQL\Schema\BlockAttributeBuilder\Multiple');
