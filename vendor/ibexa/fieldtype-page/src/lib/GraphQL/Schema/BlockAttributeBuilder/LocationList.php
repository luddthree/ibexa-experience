...
class LocationList implements BlockAttributeBuilder
{
    ...
    {
        $resolve = sprintf(
            '@=resolver("LocationListStorageValue", [value.getAttribute("%s").getValue()])',
...
class_alias(LocationList::class, 'EzSystems\EzPlatformPageFieldType\GraphQL\Schema\BlockAttributeBuilder\LocationList');
