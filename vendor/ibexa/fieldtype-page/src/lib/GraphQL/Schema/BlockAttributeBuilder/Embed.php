...
class Embed implements BlockAttributeBuilder
{
    ...
    {
        $resolve = sprintf(
            '@=resolver("EmbedAttributeValue", [value.getAttribute("%s").getValue()])',
...
class_alias(Embed::class, 'EzSystems\EzPlatformPageFieldType\GraphQL\Schema\BlockAttributeBuilder\Embed');
