...
use Ibexa\Tests\Integration\FieldTypePage\FieldTypePageIbexaTestKernel;
...
$kernel = new FieldTypePageIbexaTestKernel('test', true);
$kernel->boot();
...
$kernel->executeMigration('landing_page.yaml');
