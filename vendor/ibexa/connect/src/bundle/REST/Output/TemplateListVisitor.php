...
final class TemplateListVisitor extends ValueObjectVisitor
{
    private const LIST_OBJECT_IDENTIFIER = 'ScenarioBlockTemplateList';
    private const OBJECT_IDENTIFIER = 'ScenarioBlockTemplate';

    /**
     * @param \Ibexa\Bundle\Connect\REST\Value\TemplateList $data
     */
    public function visit(Visitor $visitor, Generator $generator, $data): void
    {
        ...
        foreach ($data->templates as $template) {
            $visitor->visitValueObject($template);
        }
