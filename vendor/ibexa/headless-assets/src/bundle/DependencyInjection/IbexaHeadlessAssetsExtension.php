...
namespace Ibexa\Bundle\HeadlessAssets\DependencyInjection;
...
final class IbexaHeadlessAssetsExtension extends Extension implements PrependExtensionInterface
{
    /**
