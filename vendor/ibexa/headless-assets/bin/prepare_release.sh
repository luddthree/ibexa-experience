#! /bin/sh
# Script to prepare a headless-assets bundle release

[ ! -f "bin/prepare_release.sh" ] && echo "This script has to be run the root of the bundle" && exit 1

print_usage()
{
    echo "Create a new version of headless-assets bundle by creating a local tag"
...
echo "https://github.com/ibexa/headless-assets/releases"
